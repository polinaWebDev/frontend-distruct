...
import {
    loadoutAdminControllerCreateRandomChallengeMutation,
...
import type { CreateRandomChallengeDto } from '@/lib/api_client/gen/types.gen';
...
export function CreateChallengeDialog({ open, onOpenChange }: CreateChallengeDialogProps) {
    ...
    >({
        defaultValues: {
            ...
            order: 0,
            game_type: gameType,
            random_gear_challenge_group_id: '',
        },
    });
        ...
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Создайте новый рандомный челлендж для игры
                    </DialogDescription>
                </DialogHeader>
