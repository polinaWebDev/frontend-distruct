...
export type BannerSlotAdminResponseDto = {
    id: string;
    page: 'news_article' | 'challenges' | 'tiers' | 'maps';
    slotKey: string;
    width: number;
    height: number;
...
export type AuthControllerOauthCallbackResponse = AuthControllerOauthCallbackResponses[keyof AuthControllerOauthCallbackResponses];
